...
# !!! Main.UserApp is configured as an alias for Main.CyzServer and you might encounter it in some tests
using Main.CyzServer, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "CyzServer tests" begin
  @includetests ARGS
end
